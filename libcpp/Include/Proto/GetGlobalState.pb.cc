...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 7, 26, sizeof(::GetGlobalState::S2C)},
  { 40, 46, sizeof(::GetGlobalState::Request)},
  { 47, 56, sizeof(::GetGlobalState::Response)},
};
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "\006userID\030\001 \002(\004\"\262\002\n\003S2C\022\020\n\010marketHK\030\001 \002(\005\022"
      ...
      "ramStatus\030\014 \001(\0132\025.Common.ProgramStatus\022\024"
      "\n\014qotSvrIpAddr\030\r \001(\t\022\024\n\014trdSvrIpAddr\030\016 \001"
      "(\t\"+\n\007Request\022 \n\003c2s\030\001 \002(\0132\023.GetGlobalSt"
      "ate.C2S\"d\n\010Response\022\025\n\007retType\030\001 \002(\005:\004-4"
      "00\022\016\n\006retMsg\030\002 \001(\t\022\017\n\007errCode\030\003 \001(\005\022 \n\003s"
      "2c\030\004 \001(\0132\023.GetGlobalState.S2CB\025\n\023com.fut"
      "u.openapi.pb"
  };
...
void S2C::SharedCtor() {
  ...
  ::memset(&programstatus_, 0, static_cast<size_t>(
      ...
      reinterpret_cast<char*>(&programstatus_)) + sizeof(localtime_));
}
...
// @@protoc_insertion_point(message_clear_start:GetGlobalState.S2C)
  ...
  if (cached_has_bits & 16128u) {
    ::memset(&qotlogined_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&localtime_) -
        reinterpret_cast<char*>(&qotlogined_)) + sizeof(localtime_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear();
}
